...
public class Hashids {
    ...
    public Hashids(int minHashLength) {
        this(DEFAULT_SALT, minHashLength);
    }
    ...
    public String encode(long... numbers) {
        ...
        return this.encodeLong(numbers);
    }
    ...
    public long[] decode(String hash) {
        ...
        return this.decodeString(hash, this.alphabet);
    }
    ...
    private String encodeLong(long... numbers) {
    ...
    private long[] decodeString(String hash, String alphabet) {
